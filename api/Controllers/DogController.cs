...
namespace api.Controllers
{
  ...
  public class DogController : ControllerBase
  {
    ...
    [HttpPost]
    public async
    Task<IActionResult> AddBlogPost([FromBody] DogForCreation field)
    {
    ...
    [HttpGet]
    [Route("name")]
    public async Task<IActionResult> getDogWithName(String title)
    {
      var dataFromRepo = await dogRepository.GetDogWithName(title);
      if (dataFromRepo == null)
      {
        return BadRequest(new
        {
